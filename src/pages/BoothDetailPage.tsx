...
export default function BoothDetailPage() {
  ...
  return (
    <div className="pt-5">
      <div className="flex items-center space-x-[10px] mb-2 text-base-deep">
      ...
      <div className="mb-10">
        <h3 className="typo-heading-3 mb-3 text-base-deep">동아리 활동 사진</h3>
        <ImageCarousel
      ...
      <div className="mb-10">
        <h3 className="typo-heading-3 mb-3 text-base-deep">문의하기</h3>
